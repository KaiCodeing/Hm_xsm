 ...
 */
public class RqMediaAdapter extends HemaAdapter {
    private ArrayList<Media> medias;
    private RqSearchResultActivity mContext;
    private String colseType;

    public RqMediaAdapter(RqSearchResultActivity mContext, ArrayList<Media> medias, String colseType) {
        super(mContext);
        this.medias = medias;
