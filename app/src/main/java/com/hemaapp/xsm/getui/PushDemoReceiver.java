...
import com.hemaapp.xsm.push.MyPushMessageReceiver;
import com.hemaapp.xsm.push.PushUtils;
...
public class PushDemoReceiver extends BroadcastReceiver {
    ...
    public void mynotify(Context context, String content, String keytype,
        ...
        if (isForeground(context, MessageActivity.class.getCanonicalName())) {
            return;
        }
        if ("0".equals(keytype)) {
